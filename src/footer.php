<?php if (strpos($directoryName, 'driver-tools') === false && strpos($directoryName, 'trip-management') === false) { ?>
    <footer class="footer" id="footer" style="font-size: 14px;">
        <span>&copy; 2023-2025 <a class="text-mron" href="https://ronbodnar.com/">Ron Bodnar</a> — Demo Prototype Only</span>
    </footer>
<?php } else { ?>
    <?php
...
if ($directoryName == 'trip-management') {
    echo '<script src="/assets/js/trip-management.js"></script>';
}
?>
</body>
