...
if (strcmp($action, 'list') === 0) {
    ...
    foreach ($shipments as $shipment) {
        $data = array(
            'id' => $shipment->getId(),
            'name' => '<a href="/projects/logistics-management/src/views/drivers/details.php?id=' . $shipment->getId() . '" class="text-mron">' . $shipment->getFullName() . '</a>',
        );
    ...
    foreach ($shipments as $shipment) {
        ...
        $data = array(
            ...
            'name' => '<a href="/projects/logistics-management/src/views/drivers/details.php?id=' . $shipment['id'] . '" class="text-mron">' . $shipment['fullName'] . '</a>',
