...
if (isset($_POST['status'])) {
    ...
    } else if ($_POST['status'] == 'LEFT_PLANT') {
        $_SESSION['STATUS'] = 'LEFT_PLANT';
    } else if ($_POST['status'] == 'ARRIVED_AT_PLANT') {
        $_SESSION['STATUS'] = 'ARRIVED_AT_PLANT';
...
<div class="container-fluid pt-4">
    <div class="overlay-inner">
        <h3 class="text-light text-center fw-bold display-5">PLANT Workflow</h3>
    </div>
                ...
                <div class="card-body justify-content-center">
                    <div id="main">
                        ...
                        if (!isset($_SESSION['LOAD_NUMBER'])) {
                            ...
                            } else if ($status == 'LEFT_PLANT') {
                                include 'status/driving.php';
                            } else if ($status == 'LEFT_FACILITY') {
                                include 'status/driving2.php';
                            } else if ($status == 'ARRIVED_AT_PLANT') {
                                include 'status/arrival-plant.php';
                            ...
                            <form id="unavailable-form" method="post" action=".">
                                ...
                                <div class="form-group pt-3" id="stop-locations-prompt" style="display: none;">
                                    ...
                                    <select class="form-select select-caret" id="stop-locations" name="stop-locations">
                                        ...
                                        <option value="satellite">Satellite Yard</option>
                                        <option value="other" disabled>Other</option>
                                    </select>
                                    <div class="invalid-feedback">
                                        Select a location
                                ...
                                <div class="pt-4" id="satelliteYardReason" style="display: none;">
                                    <div class="form-group">
                                        <textarea class="form-control" id="satelliteYardDescription" name="satelliteYardDescription" placeholder="Briefly explain why you are stopping at the yard." style="width: 100%;" rows="3"></textarea>
                                        <div class="invalid-feedback">
