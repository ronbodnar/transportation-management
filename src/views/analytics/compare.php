                            ...
                            <div class="pt-3" id="compareFacility" style="display: none;">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" id="compareFacilityDropdown" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <li><button type="button" class="dropdown-item" id="coi">Coldstore COI</button></li>
                                        <li><button type="button" class="dropdown-item" id="ontario">Coldstore Ontario</button></li>
                                        <li><button type="button" class="dropdown-item" id="riverside">Coldstore Riverside</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
