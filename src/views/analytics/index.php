        ...
        <div class="col-md-4">
            <div class="card content d-flex">
                <div class="card-header">
                    ...
                    <span class="text-mron" style="cursor: help;" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-html="true" title="<strong>Warehouse Utilization</strong> is collected using shipments that were assigned by the Plant. All shipments 
        ...
        <div class="col-md-4">
            <div class="card content d-flex">
                <div class="card-header">
                    ...
                    <ul class='pt-2'>
                        <li syle='list-style-type: circle;'>Driving shipments from the Plant.</li>
                    ...
                    Due to the vast amount of data collected, Time Utilization can be updated at any time to reflect data that the Plant would like to see."><i class="bi bi-question-circle"></i></span>
                    <div class="dropdown">
                        <span class="card-header-options" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-three-dots"></i></span>
                        <ul class="dropdown-menu text-small shadow">
                            <li><a class="dropdown-item" href="#"><i class="bi bi-download" style="padding-right: 15px;"></i>Export CSV</a></li>
        ...
        <div class="col-md-8">
            <div class="card content d-flex">
                <div class="card-header">
                    ...
                    is assigned a shipment either through the Plant dashboard or from the fulfillment center dashboards. When a driver is assigned a shipment or a backhaul, 
