        ...
        <div class="card-body table-responsive">
            ...
            <form class="create-shipment-form" id="edit-shipment-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" novalidate>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <select class="form-control select-caret" id="weightBacere">
                                ...
                                <option value="">Plant COI</option>
                                <option value="">Coldstore COI</option>
                                <option value="">Coldstore Ontario</option>
                                <option value="">Coldstore Riverside</option>
                            </select>
                            <div class="invalid-feedback">
                ...
                <div class="d-flex justify-content-center pt-3">
                    ...
                    <button  type="button" class="btn btn-secondary mt-5 mx-5">Cancel</button>
                </div>
            </form>
        </div>
    </div>
