<div class="container-fluid pt-3">
    ...
    <div class="row">
                ...
                <div class="card-body chart-container justify-content-center">
                    <div class="row pt-2">
                        <div class="col-sm-12 text-center d-flex justify-content-around px-4">
                            <p class="fs-4 fw-bold">COI</p>
                            <div><span id="coi-target" class="fw-bold" style="color: #E69322;"><?php echo $config['targets']['coi']; ?></span><br />Target</div>
                            <div><span id="coi-sent" class="fw-bold" style="color: #E69322;">26</span><br />Shipped</div>
                            <div><span id="coi-remaining" class="fw-bold" style="color: #E69322;"><?php echo ($config['targets']['coi'] - 26); ?></span><br />Remaining</div>
                        </div>
                        <div class="col-sm-12">
                            <canvas id="coiShipmentTargetChart" style="height: 150px; width: 100%;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Coldstore Ontario Shipment Target -->
        <div class="col-sm-4">
            <div class="card content d-flex">
                <div class="dropdown">
                    <span class="card-header-options-no-header" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-three-dots"></i></span>
                ...
                <div class="card-body chart-container justify-content-center">
                    <div class="row pt-2">
                        <div class="col-sm-12 text-center d-flex justify-content-around px-4">
                            <p class="fs-4 fw-bold">Ontario</p>
                            <div><span id="ontario-target" class="fw-bold" style="color: #218B94;"><?php echo $config['targets']['ontario']; ?></span><br />Target</div>
                            <div><span id="ontario-sent" class="fw-bold" style="color: #218B94;">22</span><br />Shipped</div>
                            <div><span id="ontario-remaining" class="fw-bold" style="color: #218B94;"><?php echo ($config['targets']['ontario'] - 22); ?></span><br />Remaining</div>
                        </div>
                        <div class="col-sm-12">
                            <canvas id="ontarioShipmentTargetChart" style="height: 150px; width: 100%;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Coldstore Riverside Shipment Target -->
        <div class="col-sm-4">
            <div class="card content d-flex">
                <div class="dropdown">
                    <span class="card-header-options-no-header" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-three-dots"></i></span>
                ...
                <div class="card-body chart-container justify-content-center">
                    <div class="row pt-2">
                        <div class="col-sm-12 text-center d-flex justify-content-around px-4">
                            <p class="fs-4 fw-bold">Riverside</p>
                            <div><span id="riverside-target" class="fw-bold" style="color: #399D37;"><?php echo $config['targets']['riverside']; ?></span><br />Target</div>
                            <div><span id="riverside-sent" class="fw-bold" style="color: #399D37;">4</span><br />Shipped</div>
                            <div><span id="riverside-remaining" class="fw-bold" style="color: #399D37;"><?php echo ($config['targets']['riverside'] - 4); ?></span><br />Remaining</div>
                        </div>
                        <div class="col-sm-12">
                            <canvas id="riversideShipmentTargetChart" style="height: 150px; width: 100%;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-6">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card content d-flex">
                        <div class="card-header">
                            Available Drivers (<span id="availableDriverCount"><?php echo $database->driverRepository->getAvailableDriverCount(); ?></span>)
                            <div class="dropdown">
                        ...
                        <div class="card-body justify-content-center overflow-auto table-responsive" style="height: 200px;">
        ...
        <div class="col-sm-3">
            <div class="card content d-flex">
                <div class="card-header d-flex justify-content-between">
                    <span>Door Status (<span id="openDoorCount"><?php echo $database->dockDoorRepository->countOpenDoors(); ?></span> open)</span>
                ...
                <div class="card-body justify-content-center table-responsive" style="height: 412px;">
        ...
        <div class="col-sm-3">
            <div class="card content d-flex">
                <div class="card-header">
                    Yard Status (<span id="yardCount"><?php echo $database->yardRepository->countTrailersInYard(); ?></span>)
                    <span class="card-header-options"></span>
                </div>
                <div class="card-body justify-content-center table-responsive" style="height: 412px;">
...
<div id="assign-other-popover" style="display: none;">
    ...
    <div class="assign-empty-facilities" style="display: none;">
        ...
        <div class="row d-flex align-items-center justify-content-center pt-2">
            <div class="col-sm-6 text-center p-3">
                <a class="btn btn-mron pu-empty" data-facility="coi">COI</a>
            </div>
            <div class="col-sm-6 text-center p-3">
                <a class="btn btn-mron pu-empty" data-facility="ontario">Ontario</a>
            </div>
            <div class="col-sm-6 text-center p-3">
                <a class="btn btn-mron pu-empty" data-facility="riverside">Riverside</a>
            </div>
            <div class="col-sm-6 text-center p-3">
                <a class="btn btn-mron pu-empty" data-facility="satellite">Satellite Yard</a>
            </div>
        </div>
    </div>
    ...
    <div class="assign-backhaul-facilities" style="display: none;">
        ...
        <div class="row d-flex align-items-center justify-content-center pt-2">
            <div class="col-sm-4 text-center p-3">
                <a class="btn btn-mron pu-backhaul" data-facility="coi">COI</a>
            </div>
            <div class="col-sm-4 text-center p-3">
                <a class="btn btn-mron pu-backhaul" data-facility="ontario">Ontario</a>
            </div>
            <div class="col-sm-4 text-center p-3">
                <a class="btn btn-mron pu-backhaul" data-facility="riverside">Riverside</a>
            </div>
        </div>
    </div>
</div>
...
<div class="assign-rescue-popover" style="display: none;">
    ...
    <div class="row d-flex align-items-center justify-content-center pt-2">
        <div class="col-sm-6 text-center p-3">
            <a class="btn btn-mron pu-shipment" id="5012802599" data-facility="satellite">5012802599</a>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row gx-3 gy-2 d-flex align-items-center justify-content-around">
                    <div class="col-sm-7">
                        <label for="shipment-target-coi" class="fw-bold">Coldstore COI</label>
                    </div>
                    <div class="col-sm-5">
                        <input type="text" class="form-control target mx-5 text-center" id="shipment-target-coi" name="shipment-target-coi" style="width: 60%;" placeholder="0" autocomplete="off" value="<?php echo $config['targets']['coi']; ?>" autofocus>
                    </div>

                    <div class="col-sm-7">
                        <label for="shipment-target-ontario" class="fw-bold">Coldstore Ontario</label>
                    </div>
                    <div class="col-sm-5">
                        <input type="text" class="form-control target mx-5 text-center" id="shipment-target-ontario" name="shipment-target-ontario" style="width: 60%;" placeholder="0" autocomplete="off" value="<?php echo $config['targets']['ontario']; ?>" autofocus>
                    </div>

                    <div class="col-sm-7">
                        <label for="shipment-target-riverside" class="fw-bold">Coldstore Riverside</label>
                    </div>
                    <div class="col-sm-5">
                        <input type="text" class="form-control target mx-5 text-center" id="shipment-target-riverside" name="shipment-target-riverside" style="width: 60%;" placeholder="0" autocomplete="off" value="<?php echo $config['targets']['riverside']; ?>" autofocus>
                    </div>
                </div>
