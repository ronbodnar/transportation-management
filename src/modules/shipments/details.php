    ...
    <div class="container-fluid pt-3">
        ...
        <div class="card content mt-5">
            <div class="card-header-options-no-header">
                <a href="/projects/logistics-management/shipments/edit?id=<?php echo $shipment->getId(); ?>" class="btn btn-sm btn-secondary mt-2"><i class="bi bi-pencil"></i> Edit Shipment</a>
            </div>
