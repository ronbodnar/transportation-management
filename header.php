            ...
            <div class="notification-body">
                <div class="notification">
                    <div class="notification-content">
                        Fransisco Albarran put empty trailer 5005 into D6
                    </div>
                    <div class="time">
                        10 min
                    </div>
                ...
                <div class="notification">
                    <div class="notification-content">
                        Fransisco Albarran has arrived with an empty trailer
                    </div>
                    <div class="time">
                        14 min
                    </div>
                ...
                <div class="notification">
                    <div class="notification-content">
                        Joseph Curiel put empty trailer 50161 into D11
                    </div>
                    <div class="time">
                        17 min
                    </div>
                ...
                <div class="notification">
                    <div class="notification-content">
                        Ricardo Torres was assigned a shipment to AC COI.
                    </div>
                    <div class="time">
                        24 min
                    </div>
                ...
                <div class="notification">
                    <div class="notification-content">
                        Ricardo Torres put empty trailer 7750 into D15
                    </div>
                    <div class="time">
                        29 min
                    </div>
                ...
                <div class="notification">
                    <div class="notification-content">
                        Joseph Curiel has arrived with an empty trailer
                    </div>
                    <div class="time">
                        38 min
                    </div>
                ...
                <div class="notification">
                    <div class="notification-content">
                        Ricardo Torres has arrived with an empty trailer
                    </div>
                    <div class="time">
                        1h 35m
                    </div>
                ...
                <div class="notification">
                    <div class="notification-content">
                        Rodrigo Rodriguez was assigned a shipment from D9
                    </div>
                    <div class="time">
                        1h 44m
                    </div>
