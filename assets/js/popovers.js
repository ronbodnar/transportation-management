...
$(document).ready(function () {
  ...
  $(document).on("click", ".pu-backhaul", function (e) {
    ...
    var facilityName = ""
    if (facility === "coi") {
      facilityName = "Coldstore COI"
    } else if (facility === "ontario") {
      facilityName = "Coldstore Ontario"
    } else if (facility === "riverside") {
      facilityName = "Coldstore Riverside"
    }
  ...
  $(document).on("click", ".pu-empty", function (e) {
    ...
    if (facility === "coi") {
      ...
      facilityName = "Coldstore Riverside"
    } else if (facility === "satellite") {
      facilityName = "the Satellite Yard"
    }
    ...
    $.ajax({
      ...
      if (data["id"]) {
        ...
        $(".popover-body #view-more").attr(
          "href",
          fileLocation + "../../src/views/shipments/details.php?id=" + id
        )
      } else {
