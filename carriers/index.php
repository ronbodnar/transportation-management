...
?>
    <div class="container-fluid pt-3">
        <div class="overlay-inner">
            <h3 class="text-light align-self-left fw-bold pt-3">Carrier Details</h3>
        </div>
                            ...
                            <div class="row pt-2 d-flex justify-content-center">
                                <div class="col-md-10">
                                    ...
                                    <div class="row pt-2 pb-3 d-flex justify-content-around align-items-center">
                                        ...
                                        <div class="col-md-3 offset-md-1 fw-bold pb-2 pt-2" style="font-size: 0.9rem;">Weight</div>
                                        ...
                                        <div class="col-md-3 offset-md-1 pb-2" id="averageShiftTime" style="border-bottom: 1px solid var(--separator-line-color);"><?php echo number_format($shipment->getNetWeight()); ?></div>
                                        ...
                                        <div class="col-md-3 offset-md-1 pb-2" id="averageInstructionTime" style="border-bottom: 1px solid var(--separator-line-color);"><?php echo (strlen($shipment->getDriver()->getFullName()) <= 1 ? 'Unassigned' : '<a href="/projects/tms/drivers?id=' . $shipment->getDriver()->getId() .'" class="text-mron">' . $shipment->getDriver()->getFullName() . '</a>'); ?></div>
                                        <div class="col-md-3 offset-md-1 pb-2" id="averageInstructionTime" style="border-bottom: 1px solid var(--separator-line-color);"><a href="#" class="text-mron"><?php echo $shipment->getCarrier(); ?></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
