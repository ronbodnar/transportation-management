...
if (strcmp($requestMethod, 'GET') === 0) {
    ...
    if (strcmp($action, 'get-shipment') === 0) {
        ...
        foreach ($shipments as $shipment) {
            ...
            $id = '<a class="text-mron" href="https://mron.dev/projects/tms/shipments/details?id=' . $shipment->getId() . '" target="_blank">' . $shipment->getId() . '</a>';
        ...
        foreach ($shipments as $shipment) {
            $id = $shipment->getId();
            $location = $shipment->getDropLocation();
            $trailer = $shipment->getTrailerId();
