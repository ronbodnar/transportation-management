            ...
            <div class="card-body table-responsive">
                ...
                <form class="create-shipment-form" id="edit-shipment-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" novalidate>
                    ...
                    <div class="d-flex justify-content-center pt-3">
                        <button type="button" class="btn btn-mron mt-5 mx-5">Submit Changes</button>
                        <button type="button" class="btn btn-secondary mt-5 mx-5" onclick="window.location.href='https://mron.dev/projects/tms/shipments/details?id=<?php echo $shipment->getId(); ?>'">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
